    ...
    if (isChangeBg) {
      ...
      let timer = setInterval(() => {
        ...
        if (musiccover) {
          ...
          newDiv.setAttribute("id", "iconfontmusic");
          heoMusicPage.appendChild(newDiv);
          newDiv.addEventListener("click", function () {
            const iconfontmusic = document.getElementById("iconfontmusic");
            if (flag) {
              document.querySelector("meting-js").setAttribute("mini", flag);
              iconfontmusic.setAttribute("class", "iconfontmusic");
              flag = false;
            } else {
              document.querySelector("meting-js").setAttribute("mini", flag);
              iconfontmusic.setAttribute("class", "iconfontmusics");
              flag = true;
            }
          });
          ...
          if (window.location.pathname === "/music/") {
            document.querySelector("meting-js").setAttribute("mini", false);
            document.querySelector("meting-js").setAttribute("show", true);
          } else {
            if (window.innerWidth < 768) {
              document.querySelector("meting-js").setAttribute("mini", true);
              document.querySelector("meting-js").setAttribute("show", false);
              const iconfontmusic = document.getElementById("iconfontmusic");
              iconfontmusic.setAttribute("class", "iconfontmusic");
            } else {
              document.querySelector("meting-js").setAttribute("mini", false);
...
document.addEventListener("pjax:complete", (e) => {
  if (e.target.location.pathname === "/music/") {
    const iconfontmusic = document.getElementById("iconfontmusic");
    iconfontmusic.setAttribute("class", "");
    document.querySelector("meting-js").setAttribute("mini", false);
    document.querySelector("meting-js").setAttribute("show", true);
  } else {
    if (window.innerWidth < 768) {
